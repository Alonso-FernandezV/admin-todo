...
export const metadata = {
    title: 'Mi carrito de compras UwU',
        ...
        <div className='flex flex-col w-full sm:w-4/12'>
            ...
            <WidgetItem title={'Total a pagar'}>
              <div className='mt-2 flex justify-center gap-4'>
                <h3 className='text-3xl font-bold text-black '>${(totalToPay * 1.15).toFixed(2)}</h3>

              </div>
              <span className='font-bold text-center text-black '>Impuestos 15%: ${(totalToPay * 0.15).toFixed(2)}</span>
            </WidgetItem>
        </div>
      </div>
    </div>
